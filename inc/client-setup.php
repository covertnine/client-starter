	...
	if (class_exists('WP_Block_Patterns_Registry')) {
		...
		register_block_pattern(
			...
			array(
				...
				'description' 	=> _x('Start building your audience before you launch with a coming soon page that captures emails or phone numbers.', 'c9-starter'),
				...
				'categories'	=> array('COVERT NINE', 'Video', 'Headers', 'Buttons', 'Text')
			),
		);
		register_block_pattern(
