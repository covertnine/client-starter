...
function c9starter_register_block_patterns_cat()
{
	if (class_exists('WP_Block_Patterns_Registry')) {
		register_block_pattern_category(
			'COVERT NINE',
			array('label' => __('COVERT NINE', 'c9-starter'))
		);
		register_block_pattern_category(
			'Video',
			array('label' => __('Video', 'c9-starter'))
		);
		register_block_pattern_category(
			'Audio',
			array('label' => __('Audio', 'c9-starter'))
		);
		register_block_pattern_category(
			'Article',
			array('label' => __('Article', 'c9-starter'))
		);
	}
}
	...
	if (class_exists('WP_Block_Patterns_Registry')) {
		...
		register_block_pattern(
			...
			array(
				...
				'description' 	=> _x('Feature a video file you upload with a link to a YouTube video link.', 'c9-starter'),
				'content'		=> "<!-- wp:media-text {\"mediaPosition\":\"right\",\"mediaId\":1935,\"mediaLink\":\"https://music.local/starter-content-setup/new-section-templates-web/\",\"mediaType\":\"video\"} -->\n<div class=\"wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile\"><figure class=\"wp-block-media-text__media\"><video controls src=\"https://music.local/wp-content/uploads/2020/12/new-section-templates-web.mp4\"></video></figure><div class=\"wp-block-media-text__content\"><!-- wp:heading {\"level\":3} -->\n<h3>Using C9 Blocks Plugin</h3>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph {\"placeholder\":\"Content…\",\"fontSize\":\"small\"} -->\n<p class=\"has-small-font-size\">If you haven\'t, we highly recommend installing the C9 Blocks and C9 Admin Dashboard Plugins. <strong>For animations, and additional child theme features like a single page animated website, get on the C9 email list.</strong></p>\n<!-- /wp:paragraph -->\n\n<!-- wp:buttons {\"align\":\"center\"} -->\n<div class=\"wp-block-buttons aligncenter\"><!-- wp:button -->\n<div class=\"wp-block-button\"><a class=\"wp-block-button__link\" href=\"https://www.youtube.com/watch?v=8qyP5abkoe4\" target=\"_blank\" rel=\"noreferrer noopener\">YouTube Video Pop</a></div>\n<!-- /wp:button --></div>\n<!-- /wp:buttons --></div></div>\n<!-- /wp:media-text -->",
				'categories'	=> array('COVERT NINE', 'Video')
			),
		);
		register_block_pattern(
			...
			array(
				...
				'description' 	=> _x('Highlight important information, and link to two separate places with buttons.', 'c9-starter'),
		...
		register_block_pattern(
			...
			array(
				...
				'description' 	=> _x('Embed a playlist, track listing or lyrics, and a button to open it up!', 'c9-starter'),
